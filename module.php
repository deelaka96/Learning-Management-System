    ...
    $modulename=$_GET['modname'];
    
    $lsname=$conn->query("SELECT * FROM lec_materials ");
    $smname=$conn->query("SELECT * FROM lec_materials WHERE module_name ='$modulename'");
...
<?php endif?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <?php echo $_GET['modname'];?>
        </div>
        <div class="panel-body">
        <div id="content">
       <?php while($row = $smname->fetch_assoc()):?>
       <a href="<?php echo "uploads/materials/".$row['material'];?>" id="fe">
      <?php echo $row['lesson_name'];?>
           <?php if($_SESSION['user_name']=="admin"):?>
            &nbsp;
           <a href="remlsn.php?lsnname=<?php echo $row['lesson_name'];?>&modname=<?php echo $modulename;?>" class=".btn-default">&times;</a><?php endif?>
      </a><br><br>
  ...
  <div class="modal fade" id="uploadfile" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="formdtu">
        <form name="dtu" role="form" method="post"  action="docupload.php?modname=<?php echo $modulename?>" onsubmit="createelement()" enctype="multipart/form-data" >
